...
import { LayoutDashboard, ShoppingBag, MessageSquare, Globe, LogOut } from "lucide-react";
...
export default function AdminSidebar() {
    ...
    return (
        <aside className="w-72 bg-slate-950 text-white flex flex-col fixed h-full z-50 transition-all font-sans">
            <div className="p-8">
